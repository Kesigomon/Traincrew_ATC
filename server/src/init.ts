...
const nextSignals = new Map<SignalNames, SignalNames[]>([
  ...
  ['大道寺入換105R', ['大道寺入換110R']],
  // 下り
  ['大道寺入換112L', ['大道寺入換110LC', '大道寺入換110LD']],
  ['大道寺入換110LC', ['大道寺入換103L']],
  ['大道寺入換110LD', ['大道寺入換104L']],
...
const nextEnterSignals = new Map<SignalNames, SignalNames[]>([
  ...
  ['津崎上り出発3R', ['津崎上り出発2R']],
  // 浜園
  ['浜園上り出発2R', ['浜園入換101L', '浜園入換102R']],
  ['浜園入換102R', ['浜園入換101L', '浜園上り出発2R']],
  // 新野崎
  ['新野崎上り場内1RA', ['新野崎上り場内1RB']],
  ['新野崎上り場内1RB', ['新野崎上り場内1RA', '新野崎上り出発11R', '新野崎入換111R']],
  ['新野崎上り出発11R', ['新野崎上り出発12R', '新野崎上り場内1RB', '新野崎入換111R', '新野崎入換101L']],
  ...
  ['大道寺入換105R', ['大道寺入換110LC', '大道寺入換110LD', '大道寺入換112L']],
  ['大道寺入換110R', ['大道寺入換112L', '大道寺入換110LC', '大道寺入換110LD']],
  // 下り
  // 大道寺
  ['大道寺入換103L', ['大道寺上り場内8R', '大道寺下り出発1L']],
  ['大道寺入換104L', ['大道寺下り出発2L']],
  ['大道寺入換110LC', ['大道寺入換105R', '大道寺入換110LD', '大道寺入換110R']],
  ['大道寺入換110LD', ['大道寺入換105R', '大道寺入換110LC', '大道寺入換110R']],
  ...
  // 浜園
  ['浜園入換101L', ['浜園入換102R', '浜園下り場内2L', '浜園下り出発1L']],
  ['浜園下り場内2L', ['浜園入換101L']],
  ['浜園下り出発1L', ['浜園入換101L']],
  // 津崎
  ['津崎下り場内3LA', ['津崎下り場内3LB']],
